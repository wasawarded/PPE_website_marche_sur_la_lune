...
<table border="1" width="100%">
    <caption style="padding-bottom:20px;">
        <strong><u><center>Résultats du traitement des dumps pour le mot logique en arabe</center></u></strong>
    </caption>
    <thead>
        <tr>
            <th>Numéro</th>
...
while read -r url; do
    ...
    dump_file="$dumps_dir/dump_ar_$number.txt"
    context_file="$contextes_dir/logique_arabe-$number-context.html"
    concordance_file="$concordances_dir/logique_arabe-$number-concordance.html"
